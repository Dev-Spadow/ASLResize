...
public final class GameFont extends Rasterizer2D {
	...
	public GameFont(boolean flag, String s, FileArchive fileArchive) {
	...
	for(int l = 0; l < 256; l++) {
		anIntArray1494[l] = buffer_1.readUnsignedByte();
		anIntArray1495[l] = buffer_1.readUnsignedByte();
		...
		if(k1 == 0) {
			for(int i2 = 0; i2 < l1; i2++)
				aByteArrayArray1491[l][i2] = buffer.readSignedByte();

			} else if(k1 == 1) {
				for(int j2 = 0; j2 < i1; j2++) {
					for(int l2 = 0; l2 < j1; l2++)
					aByteArrayArray1491[l][j2 + l2 * i1] = buffer.readSignedByte();
				}
			}
	...
	public void drawCenteredString(int i, int j, String s, int l, boolean flag) {
