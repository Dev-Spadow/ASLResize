...
final class Renderable_Sub4 extends Renderable {
	...
	{
		Model model = aGraphic_1592.getModel();
		if(model == null)
			return null;
		int j = -1;
		if(aGraphic_1592.animationSequence != null)
			j = aGraphic_1592.animationSequence.primaryFrames[anInt1593];
		...
		if(aGraphic_1592.resizeXY != 128 || aGraphic_1592.resizeZ != 128)
			model_1.scale(aGraphic_1592.resizeXY, aGraphic_1592.resizeXY, aGraphic_1592.resizeZ);
		model_1.leanOverX(anInt1596);
		model_1.light(64 + aGraphic_1592.modelBrightness, 850 + aGraphic_1592.modelShadow, -30, -50, -30, true);
			return model_1;
	}

	public Renderable_Sub4(int i, int j, int l, int i1, int j1, int k1,
						   int l1, int i2, int j2, int k2, int l2)
	{
		aBoolean1579 = false;
		aGraphic_1592 = Graphic.cache[l2];
		anInt1597 = k1;
		anInt1580 = j2;
		anInt1581 = i2;
		anInt1582 = l1;
	...
	public void method456(int i)
	{
		...
		if(aGraphic_1592.animationSequence != null)
			for(anInt1594 += i; anInt1594 > aGraphic_1592.animationSequence.method258(anInt1593);)
			{
				anInt1594 -= aGraphic_1592.animationSequence.method258(anInt1593) + 1;
				anInt1593++;
				if(anInt1593 >= aGraphic_1592.animationSequence.anInt352)
					anInt1593 = 0;
			}
	...
	private final Graphic aGraphic_1592;
