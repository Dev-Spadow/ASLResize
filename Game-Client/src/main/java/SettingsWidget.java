public class SettingsWidget extends Widget {
    ...
    public static final int MAIN_INTERFACE_ID = 904;

    public static void widget() {
        Widget tab = addTabInterface(MAIN_INTERFACE_ID);
    ...
    public static void switchSettings(int button) {
        ...
        Widget.interfaceCache[MAIN_INTERFACE_ID].children[9] = tabs[tab];
    }

    public static void updateSettings() {
		/* Settings */
        Widget.interfaceCache[ACCEPT_AID].active = true;
        Widget.interfaceCache[RUN].active = Client.instance.variousSettings[152] == 1;
