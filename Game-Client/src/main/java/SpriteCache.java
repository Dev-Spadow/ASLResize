...
/**
* @Author Unknown
 * System used to load sprites externally to avoid the 8bit sprite limit imposed on the runescape kits
 */
...
public final class SpriteCache implements Closeable {
    ...
    public void init() throws IOException {
        ...
        System.out.println(String.format("Sprite kits size=%d", cache.length));
    }
    ...
    public Sprite lookup(int id) {
        try {
            ...
            try (InputStream is = new ByteArrayInputStream(dataBuf.array())) {
                ...
                // kits so we don't have to perform I/O calls again
                cache[id] = sprite;
